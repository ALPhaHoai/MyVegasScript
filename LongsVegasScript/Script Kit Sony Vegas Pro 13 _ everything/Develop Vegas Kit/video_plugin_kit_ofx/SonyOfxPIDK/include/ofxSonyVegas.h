...
/** @brief Integer property array on a host property set for version information defined in OFX 1.2 */
#define kOfxPropVersion "OfxPropVersion"

/** @brief Integer property array on a host property set for version information defined in OFX 1.2 */
#define kOfxPropAPIVersion "OfxPropAPIVersion"

/** @brief String property on an effect for description text defined in OFX 1.2 */
...
/** @brief Integer property indicates the open/closed state of a UI group defined in OFX 1.2 */
...
/** @brief Message Type to setPersistentMessage function of Message Suite V2 defined in OFX 1.2 */
#define kOfxMessageWarning "OfxMessageWarning"


/** @brief Name of the time line suite (defined in OFX 1.1) */
#define kOfxTimeLineSuite "OfxTimeLineSuite"

/** @brief bool/int parameter properties if host has a built in overlay handle defined in OFX 1.2 */
#define kOfxParamPropHasHostOverlayHandle "kOfxParamPropHasHostOverlayHandle"
