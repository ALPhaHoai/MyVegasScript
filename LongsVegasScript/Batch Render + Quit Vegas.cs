...
public class EntryPoint
{
    ...
    public void FromVegas(Vegas vegas)
    {
        ...
        if (File.Exists(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\PreExitSave.veg"))
            MessageBox.Show(
                "Your not using this for the first time, please backup the PreExitSave.veg\nwhich is in My Documents before continuing. Or if you are sure you saved your earlier project in another file then continue.");
    ...
    DialogResult ShowBatchRenderDialog()
    {
        ...
        ShutDownState.Text = "Exit Vegas when all rendering completes";
    ...
    DialogResult ShowShutDownDialog()
    {
        ...
        textLabel.Text = "Vegas exit in progress...";
    ...
    void TimTick(object sender, EventArgs e)
    {
        ...
        {
            myVegas.SaveProject(
                Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\PreExitSave.veg");
            myVegas.Exit();
